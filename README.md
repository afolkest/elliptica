...
Elliptica is a modular framework for making 2d visual arts using elliptic boundary value problems, often in the form of laws of physics.  
You place objects on a canvas, impose boundary conditions on them, and then solve a partial differential
...
Making good art requires rapid iteration and large amounts of trial and error, so the software is made with
...
visualizations of physics, although accurate representation of some aspects of the physics
is a side effect. This software is all about making beautiful things. The laws of physics happen to be
extremely helpful.
